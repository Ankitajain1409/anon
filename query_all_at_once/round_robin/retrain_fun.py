...
def retrain(new_house, new_start,new_end, pool_houses, train, test, given_date, data_aggregated, appliance_column):
    n=99
    if new_house==0:
    ...
    ranks_across_houses = np.array(ranks_list[:,appliance_column])
